    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:flex-shrink-0">
          <div class="flex items-center justify-between px-6 py-4 bg-green-700 md:flex-shrink-0 md:justify-center md:w-56">
            ...
            <dropdown class="md:hidden" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 px-8 py-4 bg-green-700 rounded shadow-lg">
                  <main-menu />
                </div>
              </template>
            </dropdown>
            ...
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  ...
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" href="/users" v-if="auth.user.role_id==1">Manage Users</Link>
